...
echo ""
echo "You should now take steps to rename the DG-CLONE USB stick. Give it a new, UNIQUE 'DG-' name specific to you or to its intended use, like 'DG-MARK1' or 'DG-MACBOOK'."
echo ""
